...
import { changeCommentModalState, createCommentInApi, editComment } from '../actions';
    ...
    return (
      ...
      >
        <div>
          ...
          <input type="hidden" name="parentId" value={parentId || this.state.parentId} disabled={parentId} />
...
const mapDispatchToProps = dispatch => ({
  ...
  editComment: (id, body, timestamp) => dispatch(editComment(id, body, timestamp))
});
